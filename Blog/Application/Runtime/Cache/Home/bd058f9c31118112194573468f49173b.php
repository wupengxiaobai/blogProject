    ...
    <article class="blogs">
        <h1 class="t_nav">
            <span>您当前的位置：<a href="<?php echo U('index');?>">首页</a>&nbsp;&gt;&nbsp;
                <a href="<?php echo U('knowledge');?>">学无止境</a>&nbsp;&gt;&nbsp;<a href="javascript:;"></a></span>
            <a href="<?php echo U('index');?>" class="n1">网站首页</a>
            <a href="javascript:;" class="n2">学无止境</a>
        </h1>
        <div class="index_about">
            ...
            <div class="nextinfo">
                <p>上一篇：<a href="<?php echo U('know',array('id'=>$arr['prev']['id']));?>"><?php echo ($arr['prev']['title']); ?></a>
                    <?php if(empty($arr['prev'])): ?>没有了...<?php endif; ?>
                </p>
                <p>下一篇：<a href="<?php echo U('know',array('id'=>$arr['next']['id']));?>"><?php echo ($arr['next']['title']); ?></a>
            ...
            <div class="news">
                ...
                <ul class="rank">
                    ...
                    <?php if(is_array($newArticle)): $i = 0; $__LIST__ = $newArticle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <a href="<?php echo U('know',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>"><?php echo (msubstr($vo["title"],0,10)); ?><span
