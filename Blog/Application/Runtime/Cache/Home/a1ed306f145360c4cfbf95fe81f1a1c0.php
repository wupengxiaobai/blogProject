...
<body>
    ...
    <article class="blogs" style="min-height:530px;">
        <h1 class="t_nav">
            ...
            <a href="javascript:;" class="n2">学无止境</a></h1>
        <div class="newblog left" style="min-height:470px;">

            <!-- 知识列表 -->
            <?php if(is_array($knowledge)): $key = 0; $__LIST__ = $knowledge;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><div class="knowledge-item">
                    ...
                    <ul class="nlist" style="overflow:hidden">
                        ...
                        <a href="<?php echo U('know',array('id'=>$vo['id']));?>" target="" class="readmore">阅读全文>></a>
                    </ul>
                    <div class="line"></div>
                </div><?php endforeach; endif; else: echo "" ;endif; ?>

            <p style="padding:20px;">共有 <?php echo ($totalRows); ?> 条[学无止境]</p>
            <div class="my-page">
        ...
        <aside class="right">
            <div class="rnav">
                ...
                <ul>
                    ...
                    <!-- 学习笔记类别导航 -->
                    <?php if(is_array($knowledgeType)): $key = 0; $__LIST__ = $knowledgeType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><li class="rnav<?php echo ($key); ?>">
                            <a href="<?php echo U('knowledge',array('type'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a>
            ...
            <div class="news">
                ...
                <ul class="rank">
                    ...
                    <?php if(is_array($newArticle)): $i = 0; $__LIST__ = $newArticle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <a href="<?php echo U('know',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>"><?php echo (msubstr($vo["title"],0,6)); ?><span
