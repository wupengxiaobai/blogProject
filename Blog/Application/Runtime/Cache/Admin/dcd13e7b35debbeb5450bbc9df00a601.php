    ...
    <div class="container" style="margin-bottom:100px;">
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control" id="title" placeholder="请输入生活标题">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="editor" type="text" name="content" id="content" placeholder="请输入生活内容"></textarea>
            </div>
            ...
            <div class="form-group">
                <label for="picture">选择生活封面照 <small>[不选择文件不上传]</small></label>
                <input type="file" id="picture" name="picture">
            </div>

            <input type="submit" class="btn btn-success" value="添加慢生活文章" />
